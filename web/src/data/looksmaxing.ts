...
export const ROUTINE_ZONES: RoutineZone[] = [
    ...
    blocks: [
      {
        ...
        items: [
          ...
          "Ice rolling (voir bloc dédié ci-dessous) — après le nettoyage, avant l'hydratant.",
      ...
      {
        type: "protocol",
        heading: "Ice rolling (tube de glace)",
        frequency: "Quotidien possible (idéalement le matin), après le nettoyage",
        duration: "30 secondes max par zone, 1-2 minutes pour tout le visage",
        details: [
          "Toujours avec une fine barrière entre le tube et la peau (tissu propre) — jamais sur peau mouillée, jamais posé de façon statique sur un point.",
          "Faire glisser en mouvements continus, du centre du visage vers les tempes (vers le haut et l'extérieur) ; sur le cou, mouvement descendant pour aider le drainage lymphatique.",
          "Resserre les pores, stimule la circulation, réduit le gonflement/l'aspect terne — bon complément avant l'hydratant du matin.",
          "Éviter les zones avec acné active ou peau lésée.",
        ],
        warning: "Ne jamais dépasser 5 minutes sur une même zone — risque de brûlure par le froid/gelure. Arrêter immédiatement en cas d'engourdissement ou de gêne forte.",
      },
    ],
  },
  ...
  // ─── CERNES ─────────────────────────────────────────────────
  {
    ...
    blocks: [
      ...
      {
        type: "protocol",
        heading: "Ice rolling ciblé cernes/poches",
        frequency: "Quotidien, le matin, avant le Filorga",
        duration: "10-15 secondes maximum par œil",
        details: [
          "Rouler doucement sous l'œil vers la tempe, jamais sur la paupière elle-même ni sur le globe oculaire.",
          "Le froid resserre les vaisseaux sanguins de la zone : dégonfle les poches et atténue temporairement l'aspect des cernes.",
          "Toujours avec une fine barrière (tissu propre) entre le tube et la peau, la zone du contour de l'œil étant particulièrement fine et fragile.",
        ],
        warning: "Ne jamais insister sur un point fixe. Arrêter en cas d'engourdissement.",
      },
    ],
  },
